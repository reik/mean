(function () {
    ...
    appRun.$inject = ['$rootScope', '$state', '$stateParams', '$window', '$templateCache', 'Colors', 'Authentication', 'UrlChange'];

    function appRun($rootScope, $state, $stateParams, $window, $templateCache, Colors, Authentication, UrlChange) {
